...
model_config = {'Swift_mobile':Swift_mobile, 'freetech_mobile_050':freetech_mobile_050}
...
for imgName in test_images:
    ...
    st = time.time()
    color_and_id = net.predict_color_and_id(img)
    ...
    result_alpha = 0.64 * img + 0.36 * result_color
